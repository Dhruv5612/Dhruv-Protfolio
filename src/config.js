export const config = {
    ...
    about: {
        title: "About Me",
        description: "Driven Information Technology student with a strong foundation in full-stack development and algorithmic problem-solving. Hands-on experience building dynamic web applications using the MERN stack and ASP.NET Core. Passionate about writing clean, scalable code and creating user-centric digital solutions. Eager to bring a versatile skill set, structured planning, and collaborative energy to a forward-thinking engineering team."
    },
    experiences: [
        {
